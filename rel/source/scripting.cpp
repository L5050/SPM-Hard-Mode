...
USER_FUNC(spm::item_event_data::closeActionCommand, PTR("ac"))
IF_EQUAL(LW(10), 7)
RUN_CHILD_EVT(spm::item_event_data::itemEventDataTable[1].useEvtScript)
...
EVT_BEGIN(fireBurst)
USER_FUNC(spm::item_event_data::actionCommand, PTR("ac"), 0)
USER_FUNC(spm::item_event_data::evt_unknownFunc_3, PTR("ac"), LW(13))
USER_FUNC(spm::item_event_data::closeActionCommand, PTR("ac"))
IF_EQUAL(LW(13), 7)
RUN_CHILD_EVT(spm::item_event_data::itemEventDataTable[2].useEvtScript)
USER_FUNC(unPauseGame)
RETURN()
ELSE()
USER_FUNC(unPauseGame)
